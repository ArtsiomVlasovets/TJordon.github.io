...
down.onmouseout=function(){
		...
		function fTime(){
			...
			if(portfolio) {
				...
				homeHeight = ((document.documentElement.offsetHeight) - topLineHeight - sectionHeight - portfolioHeight);	
			}else{
				homeHeight = ((document.documentElement.offsetHeight) - topLineHeight - sectionHeight);		
			}
